        ...
        <div class="row">
            ...
            <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-7">
                            <div class="form-group">
                                ...
                                <textarea name="texts" id="exampleTextarea" cols="30" rows="1" class="form-control" placeholder="Write your question"></textarea>
                            </div>
                        </div>
                ...
                <div class="post-content">
                    ...
                    <h3><a href="#" class="profile-link">Header of something ...</a> </h3>
