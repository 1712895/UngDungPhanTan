    ...
    public function profile()
    {
        if (!isset ($_SESSION["IsLogined"]) || $_SESSION["IsLogined"] != "true")
        {
            ...
            if(isset($_REQUEST['_id'])) {
                $_id = $_REQUEST['_id'];
                console_log($_id);
                $currentUser = UserModel::findbyID($_id);
                $_SESSION["Profile_NumberofPosts"]= UserModel::countNumofPost($_id);
                $_SESSION["Profile_NumberofAnswers"]= UserModel::countNumofAns($_id);
